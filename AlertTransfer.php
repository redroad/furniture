...
<div id="fb-root2" >
  ...
  <div id="list">
    <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <th scope="row">&nbsp;</th>
        <td colspan="3" id="bill">รายงานการจ่ายเงิน</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <th scope="row">&nbsp;</th>
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
          <tr id="MenuList">
            ...
            <td width="26%" align="center" valign="middle" bgcolor="#CCCCCC">วันที่ซื้อ</td>
            <td width="34%" align="center" valign="middle" bgcolor="#CCCCCC">รายการสินค้า</td>
            <td width="17%" align="center" valign="middle" bgcolor="#CCCCCC">สถานะ</td>
          </tr>
          <tr>
