...
#fb-root2 #edit table tr th table {
	text-align: left;
	font-size: large;
	font-weight: bold;
}
    ...
    <table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <th bgcolor="#CCCCCC" scope="row"><table width="99%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <th colspan="4" scope="row">&nbsp;&nbsp;&nbsp;&nbsp;<span id="add">*แก้ไขข้อมูลสินค้า</span></th>
          </tr>
          <tr>
            <th colspan="4" scope="row">&nbsp;</th>
          </tr>
            ...
            <td><form id="form5" name="form5" method="post" action="">
              <label>
                <select name="list" id="list" style="width:150 ">
                  ...
                  <option>โต๊ะ</option>
                  <option>เตียงนอน</option>
                  <option>โซฟา</option>
                  <option>ตู้เสื้อผ้า</option>
                  <option>ตู้โชว์</option>
                  <option>ชั้นวางของ</option>
                </select>
              </label>
            </form></td>
          </tr>
          ...
          <tr>
            ...
            <td><form id="form4" name="form4" method="post" action="">
              <label>
                <input type="text" name="princ" id="princ" />
              </label>
            </form></td>
          </tr>
          <tr>
